defmodule ElixirPlayground.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import ElixirPlayground.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&ElixirPlayground.ErrorHelpers.translate_error/1)
